	...
	<div class="header">
		<div class="layout">
			...
			<div class="headerL">
				...
				<div class="site">
					当前位置： <a href="/travelForum/">首页</a> &gt;<a href="/travelForum/question/questions/Index">问答</a> &gt; <span>等你回答</span>
				</div>
			</div>
			...
			<div class="col-xs-8" style="float: left">
				...
				<%-- 	<div class="assortmentbox clear_b">
						<div class="assortmentbox-inner line">
							<div class="assortmentcon" style="height: 80px;">
								<a href="/travelForum/question/questions/Index" class="hover">全部</a>
								<c:forEach items="${tab}" var="tab">
										<a href="/travelForum/question/tab/${tab.id}">${tab.tabName}</a>
								</c:forEach>
							</div>
						</div>
					</div>
				...
				<div class="panel" id="main" style="width: 770px;">
					<div class="panel-heading" style="background-color: white">
						<a style="margin-right: 2%" href="#">最新</a><span
							style="width: 2px; height: 10px"></span> <a href="#"
							style="margin-right: 2%">热门</a>
					</div>
					<hr style="margin-top: 10px;">
					<div class="panel-body" style="margin-top: -20px;">
						<ul class="clearfix">
							<c:forEach items="${noReply}" var="questions">
										...
										<div class="extra">
											<ul class="clearfix"
												...
												<div class="ques-labels"
													...
													<a class="tagiconone" href="wenda/list-0-10000020-1.html"
														target="_blank">${questions.tab.tabName}</a>
												</div>
