			...
			<div class="container">
				<div class="header-w3lsrow"> 
					<div class="menu"> 
						...
						<ul class="w3nav">
							<li><a href="/travelForum/jsp/index.jsp"> Home</a></li>
							<li><a href="/travelForum/jsp/about.jsp"> About</a></li> 
							<li><a href="/travelForum/jsp/gallery.jsp"> Gallery</a></li> 
							...
							<li><a href="/travelForum/jsp/contact.jsp" class="active"> Contact Us</a></li>
						</ul>
