	...
	<div style="width: 80%; margin: 30px 150px;">
		<div class="panel panel-default" id="main" style="">
			<div class="panel-heading" style="background-color: white">
				<span style="font-size: 16px;">发表游记</span>
			</div>
			...
			<div class="panel-body">
				<form action="/travelForum/topic/add" method="post" id="replyForm" name="f">
					...
					<div class="form-group col-sm-3" style="margin-top: 10px;">
						<label>地点</label> <select id="province" runat="server"
							class="form-control" name="province"
							onchange="selectprovince(this);" style="width: 95px;"></select> <select
							name="city" id="city" runat="server" style="width: 95px;"
