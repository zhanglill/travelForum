...
<!-- Custom Theme files -->
<link href="/travelForum/skin/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="/travelForum/skin/css/style.css" type="text/css" rel="stylesheet" media="all">  
<link href="/travelForum/skin/css/font-awesome.css" rel="stylesheet"> 			<!-- font-awesome icons --> 
<!-- //Custom Theme files -->  
<!-- js -->
						...
						<ul class="w3nav">
							...
							<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Short Codes <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="/travelForum/jsp/icons.jsp">Web Icons</a></li>
									<li><a href="/travelForum/jsp/codes.jsp">Typography</a></li>     
								</ul>
							</li> 
							<li><a href="/travelForum/jsp/contact.jsp"> Contact Us</a></li>
						</ul>
						<div class="clearfix"> </div>
					</div> 
					<div class="logo">
						<h1><a href="/travelForum/jsp/index.jsp">Drive</a></h1>
					</div>  
					<div class="header-right">   
						<ul>
							<li><a href="/travelForum/jsp/signin.jsp">SignIn</a></li>
							<li><a href="/travelForum/jsp//signup.jsp">SignUp</a></li> 
						</ul>
						<div class="clearfix"> </div> 
					</div>
					<div class="clearfix"> </div>
		...
		<div class="container"> 
			<div class="about-w3ls-row"> 
				<div class="col-md-5 about-left">
					<img src="/travelForum/skin/images/img1.jpg" class="img-responsive" alt=""/>
				</div>
	...
	<div class="services agileits-bar"> 
		<div class="container">	 
			...
			<div class="services-w3ls-row"> 
				...
				<!-- bar-js -->
				<script src="/travelForum/skin/js/bars.js"></script>
				<!-- //bar-js --> 	
			</div>	 			
		</div>	 			
	</div>			
				...
				<div class="team-row">
					<div class="col-md-3 col-sm-6 col-xs-6 team-grids">
						<div class="team-agile-img"> 
							<a href="#"><img src="/travelForum/skin/images/t1.jpg" alt="img"></a>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 team-grids">
						<div class="team-agile-img"> 
							<a href="#"><img src="/travelForum/skin/images/t2.jpg" alt="img"></a>
							<div class="view-caption">
								<div class="w3ls-info">
									<h4>Sophia </h4> 
									<p>CEO</p>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 team-grids">
						<div class="team-agile-img"> 
							<a href="#"><img src="/travelForum/skin/images/t3.jpg" alt="img"></a>
							<div class="view-caption">
								<div class="w3ls-info">
									<h4>Michael</h4> 
									<p>Staff</p>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 team-grids">
						<div class="team-agile-img"> 
							<a href="#"><img src="/travelForum/skin/images/t4.jpg" alt="img"></a>
							<div class="view-caption">
								<div class="w3ls-info">
									<h4>Daniel</h4> 
									<p>Chairman</p>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-5 footer-grids">
				<h3>Flickr</h3>
				<a  class="footer-img" href=""><img src="/travelForum/skin/images/i4.jpg" alt=""></a>
				<a class="footer-img" href=""><img src="/travelForum/skin/images/i2.jpg" alt=""></a>
				<a class="footer-img" href=""><img src="/travelForum/skin/images/i3.jpg" alt=""></a>
			</div>
			<div class="clearfix"> </div>
